...
CreateThread(function()
	...
	exports.interact:AddGlobalVehicleInteraction({
		name = 'CDN:InsertNozzleInteraction', -- optional
		id = 'CDN:InsertNozzleInteraction', -- needed for removing interactions
		distance = 8.0, -- optional
		interactDst = 8.0, -- optional
		options = {
			{
	...
	for _, model in ipairs(props) do
		exports.interact:AddModelInteraction({
			model = model,
			name = 'CDN:GasPumpInteraction', -- optional
			id = 'CDN:GasPumpInteraction', -- needed for removing interactions
